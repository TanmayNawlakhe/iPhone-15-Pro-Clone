...
const features = () => {
  ...
  return (
    <section className='h-full bg-zinc overflow-hidden common-padding'>
            ...
            <div className='flex flex-col justify-center items-center overflow-hidden'>
                ...
                <div className='flex-center flex-col sm:px-10'>
                    <div className=' relative h-[50vh] w-full flex items-center'>
                        <video ref={videoRef} muted autoPlay preload='none' playsInline id='exploreVideo' className='w-full h-full object-cover object-center'>
